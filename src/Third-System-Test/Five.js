...
export default function Task5() {
	...
	return (
		<>
			...
			<br />
			<hr />
			<h3>All matching alphabets: {uniqueAlphabets.join(", ")}</h3>
			<hr />
			<h3>All matching numbers: {uniqueNumbers.join(", ")}</h3>
			<hr />
			<h3>All matching special characters: {uniqueSpecialChars.join(", ")}</h3>
			<hr />
		</>
	)
}
